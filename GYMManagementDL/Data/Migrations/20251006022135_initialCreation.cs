        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Member_Email_Format", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("CK_Member_Phone_Format", "PhoneNumber LIKE '01%' AND PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Member_Email_Format1", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("CK_Member_Phone_Format1", "PhoneNumber LIKE '01%' AND PhoneNumber NOT LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_Time", "EndTime > StartTime");
                    table.ForeignKey(
